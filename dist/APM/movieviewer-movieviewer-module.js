(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["movieviewer-movieviewer-module"],{
...
var /** @type {?} */ LAYOUT_CONFIG = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["InjectionToken"]('Flex Layout token, config options for the library', {
    providedIn: 'root',
...
var /** @type {?} */ BREAKPOINTS = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["InjectionToken"]('Token (@angular/flex-layout) Breakpoints', {
    ...
    factory: function () {
        ...
        var /** @type {?} */ layoutConfig = Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["inject"])(LAYOUT_CONFIG);
 ...
 */
var /** @type {?} */ VERSION = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["Version"]('6.0.0-beta.17');
...
/***/ "./src/app/movieviewer/components/maincontent/maincontent.component.html":
/*!*******************************************************************************!*\
  !*** ./src/app/movieviewer/components/maincontent/maincontent.component.html ***!
  \*******************************************************************************/
...
module.exports = "<app-toolbar>\r\n\r\n</app-toolbar>\r\n\r\n<div class=\"flex-container\" style=\"padding:10px\">\r\n  <div class=\"flex-items\" *ngFor=\"let movie of movies | async\">\r\n    <div #divMovieCard (id)=\"movie.ID\" (name)=\"movie.ID\" class=\"tp-box\" [@flipState]='movie.state' (click)='toggleState(movie)'>\r\n\r\n      <div class=\"tp-box__side tp-box__front\" style=\"background-color:white;clear: both;width:350px;height:350px;\">\r\n        <div style=\"min-height:300px; \">\r\n          <img src=\"{{movie.Poster}}\" style=\"width:250px;height:250px;\" id=\"img{{movie.ID}}\" alt=\"movie {{movie.Title}}\" layout-fill>\r\n\r\n        </div>\r\n        <div class=\"tp-poster__title\">\r\n          {{movie.Title}} \r\n        </div>\r\n        \r\n\r\n      </div>\r\n      <div class=\"tp-box__side tp-box__back\" style=\"width:350px;height:350px;clear: both; z-index:0\">\r\n        <tile-back></tile-back>\r\n\r\n      </div>\r\n    </div>\r\n\r\n  </div>\r\n</div>\r\n\r\n\r\n \r\n"

/***/ }),

/***/ "./src/app/movieviewer/components/maincontent/maincontent.component.scss":
/*!*******************************************************************************!*\
  !*** ./src/app/movieviewer/components/maincontent/maincontent.component.scss ***!
  \*******************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/movieviewer/components/maincontent/maincontent.component.ts":
/*!*****************************************************************************!*\
  !*** ./src/app/movieviewer/components/maincontent/maincontent.component.ts ***!
  \*****************************************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var src_app_movieviewer_services_movie_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/movieviewer/services/movie.service */ "./src/app/movieviewer/services/movie.service.ts");
...
var MaincontentComponent = /** @class */ (function () {
    function MaincontentComponent(movieService, elRef, divMovieCard) {
        this.movieService = movieService;
        this.elRef = elRef;
        this.divMovieCard = divMovieCard;
    ...
    MaincontentComponent.prototype.ngAfterViewInit = function () {
        console.log(this.divMovieCard.nativeElement.innerHTML);
    };
    MaincontentComponent.prototype.ngAfterContentInit = function () {
        var div = this.elRef.nativeElement; //.querySelector('divMovieCard');
        console.log('-------');
        console.log(div);
    };
    MaincontentComponent.prototype.toggleState = function (movie) {
        console.log('Current state:' + movie.state);
        movie.state = movie.state === 'active' ? 'inactive' : 'active';
        if (movie.state == 'inactive') {
            var newMovie = this.movieService.getMovieById(movie.ID);
    ...
    ], MaincontentComponent.prototype, "click", void 0);
    MaincontentComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-maincontent',
            template: __webpack_require__(/*! ./maincontent.component.html */ "./src/app/movieviewer/components/maincontent/maincontent.component.html"),
            styles: [__webpack_require__(/*! ./maincontent.component.scss */ "./src/app/movieviewer/components/maincontent/maincontent.component.scss")],
            animations: [
                Object(_angular_animations__WEBPACK_IMPORTED_MODULE_2__["trigger"])('flipState', [
                    ...
                    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_2__["transition"])('active => inactive', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_2__["animate"])('500ms ease-out')),
        ...
        __metadata("design:paramtypes", [src_app_movieviewer_services_movie_service__WEBPACK_IMPORTED_MODULE_1__["MovieService"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"]])
...
/***/ "./src/app/movieviewer/components/tile-back/tile-back.component.css":
/*!**************************************************************************!*\
  !*** ./src/app/movieviewer/components/tile-back/tile-back.component.css ***!
  \**************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/movieviewer/components/tile-back/tile-back.component.html":
/*!***************************************************************************!*\
  !*** ./src/app/movieviewer/components/tile-back/tile-back.component.html ***!
  \***************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/movieviewer/components/tile-back/tile-back.component.ts":
/*!*************************************************************************!*\
  !*** ./src/app/movieviewer/components/tile-back/tile-back.component.ts ***!
  \*************************************************************************/
/*! exports provided: TileBackComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TileBackComponent", function() { return TileBackComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var TileBackComponent = /** @class */ (function () {
    function TileBackComponent() {
    }
    TileBackComponent.prototype.ngOnInit = function () {
    };
    TileBackComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'tile-back',
            template: __webpack_require__(/*! ./tile-back.component.html */ "./src/app/movieviewer/components/tile-back/tile-back.component.html"),
            styles: [__webpack_require__(/*! ./tile-back.component.css */ "./src/app/movieviewer/components/tile-back/tile-back.component.css")]
        }),
        __metadata("design:paramtypes", [])
    ], TileBackComponent);
    return TileBackComponent;
}());
...
/***/ "./src/app/movieviewer/components/toolbar/toolbar.component.html":
/*!***********************************************************************!*\
  !*** ./src/app/movieviewer/components/toolbar/toolbar.component.html ***!
  \***********************************************************************/
/*! no static exports found */
...
/***/ "./src/app/movieviewer/components/toolbar/toolbar.component.scss":
/*!***********************************************************************!*\
  !*** ./src/app/movieviewer/components/toolbar/toolbar.component.scss ***!
  \***********************************************************************/
/*! no static exports found */
...
/***/ "./src/app/movieviewer/components/toolbar/toolbar.component.ts":
/*!*********************************************************************!*\
  !*** ./src/app/movieviewer/components/toolbar/toolbar.component.ts ***!
  \*********************************************************************/
...
var ToolbarComponent = /** @class */ (function () {
    ...
    ToolbarComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./toolbar.component.html */ "./src/app/movieviewer/components/toolbar/toolbar.component.html"),
            styles: [__webpack_require__(/*! ./toolbar.component.scss */ "./src/app/movieviewer/components/toolbar/toolbar.component.scss")]
        }),
        __metadata("design:paramtypes", [])
    ], ToolbarComponent);
...
/***/ "./src/app/movieviewer/models/movie.ts":
/*!*********************************************!*\
  !*** ./src/app/movieviewer/models/movie.ts ***!
  \*********************************************/
...
/***/ "./src/app/movieviewer/movieviewer.module.ts":
/*!***************************************************!*\
  !*** ./src/app/movieviewer/movieviewer.module.ts ***!
  \***************************************************/
/*! exports provided: MovieviewerModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MovieviewerModule", function() { return MovieviewerModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _moviewviewer_app_moviewviewer_app_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./moviewviewer-app/moviewviewer-app.component */ "./src/app/movieviewer/moviewviewer-app/moviewviewer-app.component.ts");
/* harmony import */ var _components_toolbar_toolbar_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/toolbar/toolbar.component */ "./src/app/movieviewer/components/toolbar/toolbar.component.ts");
/* harmony import */ var _components_maincontent_maincontent_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/maincontent/maincontent.component */ "./src/app/movieviewer/components/maincontent/maincontent.component.ts");
...
/* harmony import */ var src_app_movieviewer_services_movie_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/movieviewer/services/movie.service */ "./src/app/movieviewer/services/movie.service.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _components_tile_back_tile_back_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/tile-back/tile-back.component */ "./src/app/movieviewer/components/tile-back/tile-back.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: '', component: _moviewviewer_app_moviewviewer_app_component__WEBPACK_IMPORTED_MODULE_3__["MoviewviewerAppComponent"],
        children: [
            { path: ':id', component: _components_maincontent_maincontent_component__WEBPACK_IMPORTED_MODULE_5__["MaincontentComponent"] },
            { path: '', component: _components_maincontent_maincontent_component__WEBPACK_IMPORTED_MODULE_5__["MaincontentComponent"] }
        ]
    },
    { path: '**', redirectTo: '' }
];
var MovieviewerModule = /** @class */ (function () {
    function MovieviewerModule() {
    }
    MovieviewerModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [
                src_app_movieviewer_services_movie_service__WEBPACK_IMPORTED_MODULE_9__["MovieService"]
            ],
            declarations: [_moviewviewer_app_moviewviewer_app_component__WEBPACK_IMPORTED_MODULE_3__["MoviewviewerAppComponent"], _components_toolbar_toolbar_component__WEBPACK_IMPORTED_MODULE_4__["ToolbarComponent"], _components_maincontent_maincontent_component__WEBPACK_IMPORTED_MODULE_5__["MaincontentComponent"], _components_tile_back_tile_back_component__WEBPACK_IMPORTED_MODULE_11__["TileBackComponent"]]
        })
    ], MovieviewerModule);
    return MovieviewerModule;
}());
...
/***/ "./src/app/movieviewer/moviewviewer-app/moviewviewer-app.component.css":
/*!*****************************************************************************!*\
  !*** ./src/app/movieviewer/moviewviewer-app/moviewviewer-app.component.css ***!
  \*****************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/movieviewer/moviewviewer-app/moviewviewer-app.component.html":
/*!******************************************************************************!*\
  !*** ./src/app/movieviewer/moviewviewer-app/moviewviewer-app.component.html ***!
  \******************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/movieviewer/moviewviewer-app/moviewviewer-app.component.ts":
/*!****************************************************************************!*\
  !*** ./src/app/movieviewer/moviewviewer-app/moviewviewer-app.component.ts ***!
  \****************************************************************************/
/*! exports provided: MoviewviewerAppComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MoviewviewerAppComponent", function() { return MoviewviewerAppComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var MoviewviewerAppComponent = /** @class */ (function () {
    function MoviewviewerAppComponent(iconRegistry, sanitizer) {
        iconRegistry.addSvgIconSet(sanitizer.bypassSecurityTrustResourceUrl);
    }
    MoviewviewerAppComponent.prototype.ngOnInit = function () {
    };
    MoviewviewerAppComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'pm-moviewviewer-app',
            template: __webpack_require__(/*! ./moviewviewer-app.component.html */ "./src/app/movieviewer/moviewviewer-app/moviewviewer-app.component.html"),
            styles: [__webpack_require__(/*! ./moviewviewer-app.component.css */ "./src/app/movieviewer/moviewviewer-app/moviewviewer-app.component.css")]
        }),
    ...
    ], MoviewviewerAppComponent);
    return MoviewviewerAppComponent;
}());
...
/***/ "./src/app/movieviewer/services/movie.service.ts":
/*!*******************************************************!*\
  !*** ./src/app/movieviewer/services/movie.service.ts ***!
  \*******************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var src_app_movieviewer_models_movie__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/movieviewer/models/movie */ "./src/app/movieviewer/models/movie.ts");
...
var MovieService = /** @class */ (function () {
    function MovieService(http) {
        this.http = http;
        this.cinemaworldUrl = 'http://webjetapitest.azurewebsites.net/api/cinemaworld/movies';
        this.dataStore = { movies: [] };
        this._movies = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"]([]);
    }
    Object.defineProperty(MovieService.prototype, "movies", {
        get: function () {
    ...
    MovieService.prototype.LoadData = function () {
        var _this = this;
        var cinemaworldUrl = './assets/json/cinemaworld.json';
        var headers = new Headers();
        headers.append("x-access-token", "sjd1HfkjU83ksdsm3802k");
        return this.http.get(cinemaworldUrl)
            .subscribe(function (data) {
            _this.dataStore.movies = data.map(function (x) { return new src_app_movieviewer_models_movie__WEBPACK_IMPORTED_MODULE_1__["Movie"](x.Title, x.Year, x.ID, x.Type, x.Poster); });
            //this.dataStore.movies = data;
            _this._movies.next(Object.assign({}, _this.dataStore).movies);
        }, function (error) {
            console.log("Failed to fetch movies");
        });
    };
    //GetMovies(): Observable<Movie[]> {
    //  const cinemaworldUrl = './assets/json/cinemaworld.json';
    //  return this.http.get<Movie[]>(cinemaworldUrl)
    //    .pipe(
    ...
    MovieService.prototype.getMovieById = function (id) {
        var _this = this;
        if (id === '') {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(this.initializeMovie());
        }
        //check if Movie Cached Before
        if (this.cachedMovies) {
            var foundItem = this.cachedMovies.find(function (item) { return item.ID === id; });
            if (foundItem) {
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(foundItem);
            }
        }
        console.log('call database');
        // const url = `${this.cinemaworldUrl}/${id}`;
        var url = './assets/json/cinemaworld_cw0076759.json';
        return this.http.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (data) { return _this.cachedMovies.push(data); }));
    };
    MovieService.prototype.initializeMovie = function () {
        // Return an initialized object
        return new src_app_movieviewer_models_movie__WEBPACK_IMPORTED_MODULE_1__["Movie"]('', '', '', '', '');
    };
...
//# sourceMappingURL=movieviewer-movieviewer-module.js.map